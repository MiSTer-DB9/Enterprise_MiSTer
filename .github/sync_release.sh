...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Enterprise_MiSTer.git"
CORE_NAME=(Enterprise)
...
UPSTREAM_CORE_NAME=(Enterprise)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Enterprise.qpf)
COMPILATION_OUTPUT=(output_files/Enterprise.rbf)
